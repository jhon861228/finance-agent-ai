import { e as createComponent, m as maybeRenderHead, r as renderTemplate, h as createAstro, g as addAttribute, k as renderComponent, l as Fragment } from '../chunks/astro/server_DqZNW82L.mjs';
import 'piccolore';
import { $ as $$Layout } from '../chunks/Layout_BZifqPDm.mjs';
import { g as getUserByUsername, a as getPersonalExpenses, b as getUserGroups, c as generateLinkingCode, $ as $$PageHeader, d as $$ExpenseItem } from '../chunks/db_CYuHL9Xb.mjs';
import 'clsx';
/* empty css                                     */
/* empty css                                     */
...
const $$TelegramLink = createComponent(($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro$1, $$props, $$slots);
  Astro2.self = $$TelegramLink;
  const { linkCode, telegramId } = Astro2.props;
  return renderTemplate`${renderComponent($$result, "Fragment", Fragment, { "data-astro-cid-g7ez6zc3": true }, { "default": ($$result2) => renderTemplate`${!telegramId && renderTemplate`${maybeRenderHead()}<section class="insights-section telegram-link-section" data-astro-cid-g7ez6zc3><div class="sec-header" data-astro-cid-g7ez6zc3><h2 data-astro-cid-g7ez6zc3>TELEGRAM LINKING</h2></div><div class="link-container" data-astro-cid-g7ez6zc3>${linkCode ? renderTemplate`<div class="premium-card text-center" data-astro-cid-g7ez6zc3><p class="muted" data-astro-cid-g7ez6zc3>Send this exactly to the bot:</p><h3 class="gold-text copy-code" data-astro-cid-g7ez6zc3>
/vincular ${linkCode}</h3><p class="muted mt-2" data-astro-cid-g7ez6zc3>
The code expires in 15 minutes.
</p></div>` : renderTemplate`<div class="premium-card text-center" data-astro-cid-g7ez6zc3><p class="muted mb-3" data-astro-cid-g7ez6zc3>
Connect your account to Telegram to record
                                expenses on the go.
</p><form method="POST" data-astro-cid-g7ez6zc3><button type="submit" name="action" value="generate-code" class="telegram-btn w-full" data-astro-cid-g7ez6zc3><span class="btn-icon" data-astro-cid-g7ez6zc3>✈️</span> LINK
                                    TELEGRAM
</button></form></div>`}</div></section>`}` })}`;
}, "/Users/usuario/Documents/Desarrollo/finance-agent-ai/frontend/src/components/TelegramLink.astro", void 0);

const $$Astro = createAstro();
const $$Dashboard = createComponent(async ($$result, $$props, $$slots) => {
  const Astro2 = $$result.createAstro($$Astro, $$props, $$slots);
  Astro2.self = $$Dashboard;
  const username = Astro2.cookies.get("username")?.value;
  ...
  const groups = await getUserGroups(user.userId, token);
  let linkCode = null;
  if (Astro2.request.method === "POST") {
    const data = await Astro2.request.formData();
    if (data.get("action") === "generate-code") {
      linkCode = await generateLinkingCode(user.userId, token);
    }
  }
  const allExpenses = [
