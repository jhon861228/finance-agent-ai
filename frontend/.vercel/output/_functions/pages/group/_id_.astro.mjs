import { e as createComponent, k as renderComponent, r as renderTemplate, h as createAstro, m as maybeRenderHead, g as addAttribute } from '../../chunks/astro/server_DqZNW82L.mjs';
import 'piccolore';
import { $ as $$Layout } from '../../chunks/Layout_BZifqPDm.mjs';
import { e as getGroupDetails, g as getUserByUsername, $ as $$PageHeader, d as $$ExpenseItem } from '../../chunks/db_CYuHL9Xb.mjs';
/* empty css                                        */
/* empty css                                   */
...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  if (!id || !username || !token) {
    if (!token) Astro2.cookies.delete("username");
